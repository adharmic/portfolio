  ...
  return (
    <Card className="max-w-80 2xl:max-w-2xl">
      <Heading className="bg-accent">
        <div className="text-xl 2xl:text-5xl p-1 border-b-2 border-foreground 2xl:p-4">
      ...
      <div className="text-xs p-1 flex flex-col h-full items-center justify-evenly ">
        <Avatar />
        <div className="m-4 text-base 2xl:text-3xl">
        ...
        <div className="self-center">
          <Button color="accent">
            <h1 className="2xl:text-4xl">Résumé</h1>
          </Button>
        </div>
      </div>
    </Card>
